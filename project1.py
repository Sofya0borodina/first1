...
def define_theme(text_):                        ### Определяем функцию, которая возвращает тематику (рубрику) статьи
        score = {"экономика": 0, "политика": 0, "наука": 0, "культура": 0, "спорт": 0}    ### Создаём словарь, который счтает очки, набранные статьёй по каждой тематике 
        ...
        return max(score, key=score.get)       ### Ищем ключ (тематику) снаибольшим значением (количеством набранных очков)
